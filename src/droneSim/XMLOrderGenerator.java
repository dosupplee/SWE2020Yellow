...
public class XMLOrderGenerator {
	...
	public XMLOrderGenerator(int numShifts)
	{
	...
	public void createIndividualOrder(int currentShift, int orderHour,int orderMin)
	{
		...
		DeliveryPoint deliveryPoint = Main.getCurrentMap().getRandomPoint();
	 ...
	 * Takes in nothing
	 * Return the randomly selected meal
	 */
	public Meal getRandomMeal()
	{
		...
		do
		{
			Meal currentMeal = Main.getAllMeals().get(i);
	...
	/*
	 * Generates and sorts a size amount of random ints
	 * Takes in integer of how many random numbers to generate
	...
	//Takes in the document to add the order to
	public void writeOrderXML(int currentShift, String currentTime,Meal meal,String clientNameStr, DeliveryPoint point)
	{
